...
import { getDirective, MapperKind, mapSchema, memoize1, mergeIncrementalResult, visitResult, } from '@graphql-tools/utils';
...
const addTypeNameToDocument = memoize1(function addTypeNameToDocument(document) {
